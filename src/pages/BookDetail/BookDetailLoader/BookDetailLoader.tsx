    ...
    <Container>
      <ContentContainer>
        ...
        <DescriptionContainer>
          ...
          <Description>
            <SkeletonLoader width="100%" height="1.6" />
            <SkeletonLoader width="78%" height="1.6" />
            <SkeletonLoader width="80%" height="1.6" />
            <SkeletonLoader width="85%" height="1.6" />
            <SkeletonLoader width="75%" height="1.6" />
            <SkeletonLoader width="85%" height="1.6" />
            <SkeletonLoader width="80%" height="1.6" />
          </Description>
        </DescriptionContainer>
